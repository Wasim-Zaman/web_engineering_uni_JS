...
// Grab carts from the cart file which matches with user ids.
const userIdsInCart = carts.filter(({userId}) => userId);

// console.log(userIdsInCart);

userIdsInCart.forEach((uic) => {
    users.forEach((user) => {
        if (user.id == uic.userId)
    ...
    uic.products.forEach(({productId, quantity}) => {
            console.log(
                "Product Id: " + productId +
                "\t\tProduct Quantity: " + quantity + "\n"
            );

            products.forEach(({price, id}) => {
